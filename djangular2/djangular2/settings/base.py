...
DEBUG_TOOLBAR_CONFIG = {
    ...
    'SHOW_TOOLBAR_CALLBACK': 'djangular2.settings.base.custom_show_toolbar',
...
WSGI_APPLICATION = 'djangular2.wsgi.application'
...
SYSTEM_EMAIL_PREFIX = "[djangular2]"

## Log settings

LOG_LEVEL = logging.INFO
HAS_SYSLOG = True
SYSLOG_TAG = "http_app_djangular2"  # Make this unique to your project.
