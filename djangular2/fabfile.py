"""
Starter fabfile for deploying the djangular2 project.
...
# CHANGEME
env.hosts = ['user@djangular2.example.com']
env.code_dir = '/srv/www/djangular2'
env.project_dir = '/srv/www/djangular2/djangular2'
env.static_root = '/srv/www/djangular2/static/'
env.virtualenv = '/srv/www/djangular2/.virtualenv'
env.code_repo = 'git@github.com:user/djangular2.git'
env.django_settings_module = 'djangular2.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/djangular2/wsgi.py" % env.code_dir)
